<?php 
    ...
    function register_contact_settings() {
        ...
        $emails_section->create_custom_option('email_title', 'Título', 'text', 'contact_group_settings');
        ...
        $whatsapp_section->create_custom_option('whatsapp_title', 'Título', 'text', 'contact_group_settings');
        ...
        $linkedin_section->create_custom_option('linkedin_title', 'Título', 'text', 'contact_group_settings');
