<?php
    ...
    function register_information_cm() {
        ...
        add_submenu_page( 'information', 'Services', 'Services', 'manage_options', 'services', 'display_services_submenu', 4);
        add_submenu_page( 'information', 'Contact', 'Contact', 'manage_options', 'contact', 'display_contact_submenu', 5);
    }
